...
```bash
macrodeck-plugin test --artifact ./artifacts/com.cjhackeryt.soundbox-0.1.0.macroDeckPlugin --report markdown --output conformance.md
```
...
macrodeck-plugin inspect --artifact ./artifacts/com.cjhackeryt.soundbox-0.1.0.macroDeckPlugin
```
